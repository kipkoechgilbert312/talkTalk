...
if(isset($_POST['account'])){
    ...
    function contacts($contCatId,$contPhone,$contName, $contCreator,$contEmail){
        $sql = "INSERT INTO accounts(OrganisationName,phone,Email,AccountLocation,AccountType) VALUES($contCatId,$contPhone,$contName, $contCreator,$contEmail)";
